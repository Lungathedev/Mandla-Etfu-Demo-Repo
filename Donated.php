...
<head>
	...
	<meta name="description" content="Cannabis gifting nonprofit">
        <meta name="keywords" content="Mandla, Mandla Etfu NPC, Etfu, etfu, nonprofit, NPC, employment, creation, power, initiative, success, fundraiser, jobs, canibu.co.za, kahrent technology africa, Liyandza, Lunga, Magagula, best, poverty, unemployment, registered nonprofit organisation">
	...
	<!-- Document Title
	============================================= -->
	<title>Mandla Etfu NPC || Donor </title>
				...
				<div class="row h-100 align-items-center justify-content-between">
					<div class="col-lg-4 col-md-6 py-5 py-md-0">
						<div class="heading-block border-bottom-0 mb-4">
							<br><br><br><br>
							<h5 class="mb-1 text-uppercase ls2 color op-06">Mandla Etfu NPC support fundraiser</h5>
							<h2 class="mb-4 nott"><span style="color:darkgreen">Donation confirmed</span></h2>
						</div>
						<div class="svg-line bottommargin-sm">
							<img src="divider-1.svg" alt="svg divider" height="20">
						</div>
						<p class="mb-5"><span style="color:black">The Mandla Etfu NPC has received your donation!<br><br>Your name and message has been added to the Mandla Etfu NPC support fundraiser donation record.<br><br>[<a href="https://mandlaetfu.org.za/Record.php">view record</a>]</span></p>
			...
			<div id="copyrights" class="bg-color">
				...
				<div class="container clearfix">
					...
					<div class="row justify-content-between align-items-center">
						<div class="col-md-6">
							© 2022 All Rights Reserved by Mandla Etfu NPC reg no. <strong>269-769 NPO</strong> [<a href="https://www.npo.gov.za" style="color:darkgreen">Verify us</a>]<br>
